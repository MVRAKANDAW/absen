      ...
      <div class="row">
          ...
          <div class="box box-danger">
          	<div class="box-header">
          		<button type="button" class="btn btn-md btn-danger" data-toggle="modal" data-target="#basicModal"><i class="fa fa-plus mr-1"> Tambah Data</i></button>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
			    <table id="example" class="table table-striped table-bordered" style="width:100%">
			        ...
			        <tbody>
			            <tr>
			                ...
			                <td>2011/04/25</td>
			                <td align="center">
			                	<button class="btn btn-warning btn-sm"  data-toggle="modal" data-target="#editsiswaModal">
       ...
       @include('front_end.modals.siswa.deleteSiswa')
       @include('front_end.modals.siswa.editSiswa')

      </div>
      <!-- /.row -->
       @include('front_end.modals.siswa.addSiswa')
    </section>
    <!-- /.content -->
  </div>
